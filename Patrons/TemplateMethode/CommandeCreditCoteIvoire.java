...
public class CommandeCreditCoteIvoire extends CommandeCredit {

    public CommandeCreditCoteIvoire(String idCommande, Societe societeCliente, ArrayList<Vehicule> vehicules) {
