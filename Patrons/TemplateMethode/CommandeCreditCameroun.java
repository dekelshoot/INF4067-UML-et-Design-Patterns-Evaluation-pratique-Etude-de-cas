...
public class CommandeCreditCameroun extends CommandeCredit {

    public CommandeCreditCameroun(String idCommande, Societe societeCliente, ArrayList<Vehicule> vehicules) {
