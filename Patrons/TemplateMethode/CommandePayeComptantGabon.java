...
public class CommandePayeComptantGabon extends CommandePayeComptant {

    public CommandePayeComptantGabon(String idCommande, Societe societeCliente, ArrayList<Vehicule> vehicules) {
