...
import Patrons.FactoryMethod.CommandePayeComptant;

public class CommandePayeComptantCameroun extends CommandePayeComptant {

    public CommandePayeComptantCameroun(String idCommande, Societe societeCliente, ArrayList<Vehicule> vehicules) {
        super(idCommande, societeCliente, vehicules);
        this.montantTva= (this.montantHt*19)/100;
        this.paysLivraison = "Cameroun";
